...
public class DriveTrain extends SubsystemBase {
    ...
    private DriveTrain() {
        m_frontLeft = new SwerveModuleDef(new TalonFX(2), new TalonFX(1), SwerveConstants.FL_STEER_INVERT,
                InvertedValue.CounterClockwise_Positive);
        m_frontRight = new SwerveModuleDef(new TalonFX(4), new TalonFX(3), SwerveConstants.FR_STEER_INVERT,
                InvertedValue.Clockwise_Positive);
        m_backLeft = new SwerveModuleDef(new TalonFX(6), new TalonFX(5), SwerveConstants.BL_STEER_INVERT,
                InvertedValue.CounterClockwise_Positive);
        m_backRight = new SwerveModuleDef(new TalonFX(8), new TalonFX(7), SwerveConstants.BR_STEER_INVERT,
                InvertedValue.Clockwise_Positive);
    }
    ...
    public ChassisSpeeds getSpeeds() {
        return swerveKinematics.toChassisSpeeds(new SwerveModuleState[] { m_frontLeft.getModuleState(),
                m_frontRight.getModuleState(), m_backLeft.getModuleState(), m_backRight.getModuleState() });
    }
